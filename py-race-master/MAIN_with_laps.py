...
#load traffic
    ...
    MAX_LAPS = 3
    race_finished = False
    finish_line_rect = pygame.Rect(1000, 1000, 200, 40)  # Adjust as needed
...
#Check for menu/reset, (keyup event - trigger ONCE)
        # Lap and finish detection logic
...
#Blit Blit..       
        ...
        # Display lap info
        lap_text = font.render(f"Laps: {lap_count}/{MAX_LAPS}", True, (255, 255, 255))
        screen.blit(lap_text, (20, 20))
        if race_finished:
            done_text = font.render("🏁 Race Complete!", True, (255, 255, 0))
            screen.blit(done_text, (screen.get_width() // 2 - 100, 50))
